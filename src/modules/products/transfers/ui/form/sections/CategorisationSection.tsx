...
export const CategorisationSection = ({ divisionId }: CategorisationSectionProps) => {
  ...
  return (
    ...
    >
      <AppFormGrid>
        <AppField label="Product category" forId="transfer-product-cat" error={errors.productCategoryId?.message} required>
          {({ labelId, describedBy }) => (
            <Controller
        ...
        <AppField label="Account category" forId="transfer-account-cat" error={errors.accountCategoryId?.message} required>
          {({ labelId, describedBy }) => (
            <Controller
