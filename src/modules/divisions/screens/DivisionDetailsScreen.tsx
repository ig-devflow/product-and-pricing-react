...
import { useDivisionDetailsScreen } from '@/modules/divisions/hooks/useDivisionDetailsScreen';
import {
  DivisionDetailsHero,
...
export const DivisionDetailsScreen = () => {
  const page = useDivisionDetailsScreen();
